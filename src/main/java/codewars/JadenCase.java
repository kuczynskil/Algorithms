...
//    aden Smith, the son of Will Smith, is the star of films such as The Karate Kid (2010)
//    and After Earth (2013). Jaden is also known for some of his philosophy that he delivers
//    via Twitter. When writing on Twitter, he is known for almost always capitalizing every word. For
...
//Note that the Java version expects a return value of null for an empty string or null.
    ...
    public String toJadenCase(String phrase) {
        if (null == phrase || phrase.length() == 0) return null;
