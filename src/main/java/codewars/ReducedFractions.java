...
//
//    Now, if you consider a given number d, how many proper fractions can be built using
//    d as a denominator?
//
...
//    for pointing this out and sorry for the use of an improper word :)
    ...
    public static long properFractions(long n) {
        ...
        int count = 1;
        for (int i = 1; i < n; i++) {
            if (n % i != 0 && gcdByEuclidsAlgorithm(n, i) == 1) count++;
        }
        return count;
    }
    ...
    public static void main(String[] args) {
        System.out.println(properFractions(100000002));
        System.out.println(gcdByEuclidsAlgorithm(15,3));
    }
}
