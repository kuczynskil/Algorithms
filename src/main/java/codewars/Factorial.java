...
//    n mathematics, the factorial of a non-negative integer n, denoted by n!, is the product
...
// 12 throw an exception of type ArgumentOutOfRangeException (C#) or IllegalArgumentException (Java)
