...
//    the printer has to use colors which, for the sake of simplicity, are named with letters from a to m.
//
...
//error_printer(s) => "8/22"
    ...
    public static String printerError(String s) {
       long errors = s.chars().filter(c -> c - 'm' > 0).count();
       return errors + "/" + s.length();
    }

    public static void main(String[] args) {
        System.out.println(printerError("aaabbbbhaijjjmxxx"));
    }
}
