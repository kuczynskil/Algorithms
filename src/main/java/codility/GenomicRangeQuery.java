    ...
    * */
    ...
    public int[] solution(String S, int[] P, int[] Q) {
        ...
        for (int i = 0; i < P.length; i++) {
            res[i] = impactFactor(S, P[i], Q[i]);
        }
        return res;
    }

    public static int impactFactor(String S, int begin, int end) {
        int res = 5;
        int tmp;
    ...
    public static void main(String[] args) {
        System.out.println(Arrays.toString(new GenomicRangeQuery().solution("CAGCCTA", new int[]{2, 5, 0},
                new int[]{4, 5, 6})));
    }
