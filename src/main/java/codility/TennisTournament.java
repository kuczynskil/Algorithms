...
//    round of this tournament, are already registered and you have reserved C tennis courts
//    for the matches. Exactly two players play in each game and only one game can be played on
//    each court at any given time. You want to host the maximum possible number of games starting
//    at the same time (in order to finish the first round quickly).
//
...
// played simultaneously (for instance, the first and second players can play on the first court, and
// the third and fourth players on the second court, and the third court will be empty because the fifth
// player does not have a partner to play with).
//
